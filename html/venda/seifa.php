...
<body>
      ...
      <img src="../../img/seifa.png" alt="" height="600px" width="100%">
      <div class="linha-gray"> 
      <div class="card-group"><!--INICIO DO CARD-->
          <?php
            include("../config/conexao.php");

          $res = mysqli_query($link,"SELECT p.* from produto p join categoria c on p.cod_categoria=c.cod_categoria where c.nome_categoria = 'Seifa' ")or die(mysqli_error($link));
          while($show=mysqli_fetch_assoc($res)){
            ...
            $img = $show['img'];
          ?>
           <div class="card" style=" border-radius: 5px; padding-bottom: 30px;">
