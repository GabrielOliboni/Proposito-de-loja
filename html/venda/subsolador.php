...
<body>
      ...
      <img src="../../img/subsolador.png" alt="" height="600px" width="100%">
      <div class="linha-gray"> 
      <div class="card-group"><!--INICIO DO CARD-->
          <?php
            include("../config/conexao.php");

          $res = mysqli_query($link,"SELECT p.* from produto p join categoria c on p.cod_categoria=c.cod_categoria where c.nome_categoria = 'Subsolador' ")or die(mysqli_error($link));
