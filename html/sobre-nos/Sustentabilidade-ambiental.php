...
<head>
    ...
    <link rel="stylesheet" href="../../style/site/Sustentabilidade-ambiental.css">
...
<?php 
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary" > <!--INICIO DA NAVEGAÇÃO-->
      ...
      <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Sustentabilidade-ambiental.php" aria-disabled="true"  style="padding-left: 40px; color: rgb(131, 31, 0);">Sustentabilidade Ambiental</a>
          </li>
        </li>
        <li class="nav-item">
...
<div class="carosel"> </div>
 <div class="main">
  ...
  <p>
    <br>
Na Auto Agro, acreditamos que a agricultura sustentável é o caminho a seguir. Estamos empenhados em promover práticas agrícolas responsáveis e produtos ecologicamente corretos. Trabalhamos com tecnologias que reduzem o consumo de recursos naturais e minimizam o impacto ambiental, ajudando a proteger o planeta para as gerações futuras.</p>
</div >
