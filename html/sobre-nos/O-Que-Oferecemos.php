...
<head>
    ...
    <link rel="stylesheet" href="../../style/site/O-Que-Oferecemoso.css">
...
<?php 
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                  ...
                  <div class="btn-group">
                    ...
                    <a    href="../contato/contato.php" style="color: rgb(131, 31, 0)!important" >CONTATO</a>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary" > <!--INICIO DA NAVEGAÇÃO-->
      ...
      <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="../sobre-nos/Quem-somos.php">Quem somos</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="O-Que-Oferecemos.php" style="padding-left: 40px; color: rgb(131, 31, 0); ">O Que Oferecemos</a>
          </li>
          <li class="nav-item">
...
<div class="carosel"> </div>
 <div class="main">
  ...
  <p>
    <br>
    Na Auto Agro, orgulhamo-nos de nossa extensa gama de máquinas agrícolas de alta performance. Oferecemos tratores robustos, colheitadeiras eficientes, implementos agrícolas de última geração e muito mais. Nossos produtos são selecionados com base na durabilidade, eficiência e tecnologia avançada para atender às necessidades de agricultores de todos os portes.</p>
</div >
