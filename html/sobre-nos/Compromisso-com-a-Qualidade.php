...
<head>
    ...
    <link rel="stylesheet" href="../../style/site/compromisso-com-a-qualidade.css">
...
<?php 
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                  ...
                  <div class="btn-group">
                    ...
                    <?php 
                    //vai fazer uma busca para saber se vc ta ou n logado
                     error_reporting(0);
                     if($_SESSION["EMAIL"]){
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary" > <!--INICIO DA NAVEGAÇÃO-->
      ...
      <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Compromisso-com-a-Qualidade.php" aria-disabled="true"  style="padding-left: 40px; color: rgb(131, 31, 0);">Compromisso com a Qualidade</a>
          </li>
          <li class="nav-item">
...
<div class="carosel"> </div>
 <div class="main">
  ...
  <p>
    <br>
    A qualidade é o nosso compromisso inabalável. Trabalhamos em estreita colaboração com os principais fabricantes de máquinas agrícolas do mundo para garantir que cada produto que oferecemos atenda aos mais altos padrões. Nossa equipe de especialistas altamente capacitados está pronta para fornecer suporte técnico e assistência em todas as etapas do ciclo de vida dos produtos.</p>
  </div >
