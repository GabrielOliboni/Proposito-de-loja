...
<head>
    ...
    <link rel="stylesheet" href="../../style/site/nossa-equipe.css">
...
<?php 
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary" > <!--INICIO DA NAVEGAÇÃO-->
      ...
      <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Nossa-Equipe.php" aria-disabled="true"  style="padding-left: 40px; color: rgb(131, 31, 0);">Nossa Equipe</a>
          </li>
          <li class="nav-item">
...
<div class="carosel"> </div>
 <div class="main">
  ...
  <p>
    ...
    Nossa equipe é formada por profissionais apaixonados por agricultura, engenheiros experientes, técnicos qualificados e especialistas em vendas. Estamos comprometidos em oferecer a você a melhor experiência em máquinas agrícolas, desde a seleção do equipamento até o suporte pós-venda.</p>
</div >
