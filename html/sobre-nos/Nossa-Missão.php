...
<head>
    ...
    <link rel="stylesheet" href="../../style/site/nossa-missao.css">
...
<?php 
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary" > <!--INICIO DA NAVEGAÇÃO-->
      ...
      <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Nossa-Missão.php"  style="padding-left: 40px; color: rgb(131, 31, 0);">Nossa Missão</a>
          </li>
          <li class="nav-item">
...
<div class="carosel"> </div>
 <div class="main">
  ...
  <p>
    <br>
    Nossa missão na Auto Agro é clara: capacitar agricultores em todo o mundo com as melhores máquinas agrícolas, tecnologia de ponta e suporte excepcional. Acreditamos que o futuro da agricultura depende da integração inteligente de máquinas e técnicas avançadas. Portanto, trabalhamos incansavelmente para oferecer equipamentos de qualidade superior que ajudem nossos clientes a enfrentar os desafios da agricultura moderna.</p>
</div >
...
<div style="justify-content: center; display: flex; padding: 30px; ">
  ...
  <div class="porque-compra" >
    <a href="https://www.negocioseguroaig.com.br/blog/fato-ou-fake/maquinas-agricolas#:~:text=O%20investimento%20n%C3%A3o%20%C3%A9%20pouco,foi%20o%20de%20m%C3%A1quinas%20agr%C3%ADcolas."> <div class="imagem-3" target="_blank"></div>
